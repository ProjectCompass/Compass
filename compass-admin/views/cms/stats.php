            ...
            echo '<div class="small-12 medium-6 large-6 columns">';
                ...
                echo '<table class="small-12">';
                    ...
                    echo '<tbody>';
                        ...
                        foreach ($query_data as $line):
                            echo '<tr>';
                                echo '<td>'.anchor('site/post/'.$line->post_slug, $line->post_title, array('target'=>'_blanck')).'</td>';
                ...
                echo '<table class="small-12">';
                    ...
                    echo '<tbody>';
                        ...
                        foreach ($query_data as $line):
                            echo '<tr>';
                                echo '<td>'.anchor('site/page/'.$line->post_slug, $line->post_title, array('target'=>'_blanck')).'</td>';
                                echo '<td>'.$line->post_views.'</td>';
                            echo '</tr>';
                        endforeach;
                    echo '</tbody>';
