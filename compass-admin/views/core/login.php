                    ...
                    echo form_open('login', 'id="login-index-form-login"');
                        ...
                        echo '<div class=row>';
                            ...
                            echo '<div class="small-5 columns">';
                                echo form_submit(array('name'=>'log', 'class'=>'button radius tiny right'), lang('login_enter'));
                            echo '</div>';
                        echo '</div>';
                    echo form_close();
                echo '</div>';
                ...
                echo '<div class="login-sigall panel white">';
                    ...
                    echo form_open('login/signup', 'id="login-signup-form-signup"');
                        ...
                        echo '<div class="row">';
                            ...
                            echo '</div>';
                            echo '<div class="small-12 columns">';
                            echo form_submit(array('name'=>'save', 'class'=>'button radius tiny right'), lang('login_save'));
                            echo '</div>';
                        echo '</div>';
                    echo form_close();
                echo '</div>';
            ...
            echo '<div class="small-10 large-4 small-centered columns">';
                ...
                echo '<div class="login-sigall panel white">';
                    ...
                    echo form_open('login/newpassword', 'id="login-newpassword-form-newpassword');
                        ...
                        echo form_submit(array('name'=>'save', 'class'=>'button radius tiny'), lang('login_send'));
                    echo form_close();
                echo '</div>';
