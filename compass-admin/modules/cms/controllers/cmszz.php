...
class Cms extends CI_Controller {
	...
	public function posts(){
		...
		elseif ($this->uri->segment(3) == 'update'):
		        ...
		        set_theme('modal', load_module('medias_view', 'insertmediasmodal', 'cms'), FALSE);
		        set_theme('modal', load_module('medias_view', 'uploadmediasmodal', 'cms'), FALSE);
		...
		elseif ($this->uri->segment(3) == 'delete' && $this->uri->segment(4) != NULL):
				...
				'model'=>'posts',
				'method'=>'return_list',
				'pagination_url'=>base_url('cms/cms/posts/'),
