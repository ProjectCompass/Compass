                        ...
                        foreach (get_query($config)->result() as $line):
                            echo '<tr>';
                                ...
                                printf("<td class='table-operations'><strong>%s</strong><br>%s %s %s</td>",
                                    ...
                                    (access('perm_updatepages_', NULL, TRUE)) ? anchor("cms/pages/update/$line->post_id", lang('core_update'), array('class'=>'table-action table-action-first update')) : NULL,
                                    (access('perm_viewpages_', NULL, TRUE)) ? anchor("page/$line->post_slug", lang('core_view'), array('class'=>'table-action view', 'target'=>'_blanck')) : NULL,
                                    (access('perm_deletepages_', NULL, TRUE)) ? anchor("cms/pages/delete/$line->post_id", lang('core_delete'), array('class'=>'table-action delete deletereg')) : NULL
                                    );
                            ...
                            echo '<div class="row collapse">';
                                ...
                                echo '<div class="small-4 columns">';
                                    echo '<div class="row collapse">';
                                        ...
                                        echo anchor('page/'.$query->post_slug, lang('core_view'), array('class'=>'small-3 button tiny secondary right', 'title'=>lang('core_view'), 'target'=>'_blanck'));
                                    echo '</div>';
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
