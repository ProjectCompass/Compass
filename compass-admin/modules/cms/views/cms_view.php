    ...
    case 'submenu':
        echo
            ...
            make_menu('submenu_item_drop', lang('cms_posts'), 'cms', 'posts', 'perm_listposts_').
                ...
                make_menu('submenu_item_drop_item', lang('cms_posts_new'), 'cms', 'posts/insert', 'perm_insertposts_').
            ...
            make_menu('submenu_item_drop', lang('cms_pages'), 'cms', 'pages', 'perm_listpages_').
                ...
                make_menu('submenu_item_drop_item', lang('cms_pages_new'), 'cms', 'pages/insert', 'perm_insertpages_').
            make_menu('submenu_item_drop_close', '', '', '', 'perm_listpages_').
            make_menu('submenu_item', lang('cms_comments'), 'cms', 'posts/comments', 'perm_comments_').
